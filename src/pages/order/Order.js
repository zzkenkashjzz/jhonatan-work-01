...
import { Row, Select, Col, Button, Card, Input, AutoComplete, Spin, Pagination, Space } from 'antd';
        ...
        <div className="content-div">
            ...
            <Row>
                ...
                <Col xs={16} sm={16} md={20} className="text-align-left">
                    <span className="font-size-20">{t('orders.section1')}</span><br />
                                        ...
                                        <Row>
                                            <Col xs={24} sm={8} md={8}>
                                                <div className="home-listing-card-content">
                                                    <span className="home-listing-title"><UnorderedListOutlined className="btn-primary home-listing-title-icon" />{t('orders.newOrder.table.title')}</span>
                                                </div>
                                            </Col>
                                            <Col xs={24} sm={6} md={8}>
                                                <Row>
